...
recipe_grid = thesis_lib.testdata.definitions.benchmark_images[name_grid]
img_grid, input_table_grid = generators.read_or_generate_image(recipe_grid, name_grid)
