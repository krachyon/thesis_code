...
saturation_model = SaturationModel(read_scopesim_linearity(
    Config.instance().scopesim_working_dir/'inst_pkgs/MICADO/FPA_linearity.dat'))
...
plt.scatter(all_stars['xcentroid'], all_stars['ycentroid'], s=2, c=np.log(chisquares), cmap='inferno')
plt.colorbar()
